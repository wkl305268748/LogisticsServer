...
public class PayService {
    ...
    @Value("${baofoo.keyStorePath}")
    private String keyStorePath;
    @Value("${baofoo.keyStorePassword}")
    private String keyStorePassword;
    @Value("${baofoo.MemberID}")
    private String MemberID;
    @Value("${baofoo.TerminalID}")
    private String TerminalID;
    @Value("${baofoo.payToBankUrl}")
    private String payToBankUrl;

    private String dataType = "xml";

    public void payToBankCard(String order,String money,String name,String card,String bank,String phone,String idcard) throws ErrorCodeException {
    ...
    public void payToBankCard(TransReqBF0040001 entity) throws ErrorCodeException {
        ...
        try {
            ...
            params.setRequestUrl(payToBankUrl);
